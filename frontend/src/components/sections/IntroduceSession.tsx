    ...
    >
      ...
      >
        {cards.map((card, index) => (
          ...
          >
            <article
              className="group relative aspect-[337.037/260] rounded-[16.85px] border border-white/[0.04] bg-[rgba(27,29,31,0.71)] transition-colors duration-[400ms] ease-out hover:-translate-y-1 hover:scale-[1.02] hover:border-accent/20 hover:bg-[#fdf1e6] sm:aspect-[337.037/382.537] lg:hover:scale-[1.04]"
              style={{
                transitionProperty: 'background-color, border-color, transform',
              }}
            >
              <div
                className="absolute flex flex-col gap-3 text-[#9ba5b0] transition-colors duration-[400ms] ease-out group-hover:text-accent sm:gap-4"
              ...
              {card.icons.map((icon, i) => (
                ...
                <img
                  ...
                  src={icon.src}
                  alt=""
                  className="pointer-events-none absolute transition-[filter] duration-[400ms] ease-out group-hover:[filter:sepia(1)_saturate(6)_hue-rotate(-15deg)_brightness(1.05)]"
                  style={{
