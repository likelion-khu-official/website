...
> **개발 지표** (2026-07-18 · 익명 관점 GWT 기준)
> 검증 커버리지 **69%** (66/96) · pass율 **86%** (57/66) · fail **9건** — 이슈 연결 4 · **미등록 5** ← 다음 미션 후보
> <sub>정의·산출 방법: [pm/docs/metrics.md](pm/docs/metrics.md) · ID별 근거: [pm/qa/](pm/qa/) — 검증 결과가 바뀐 턴에 이 줄도 같이 갱신(트리와 동일 규칙)</sub>
