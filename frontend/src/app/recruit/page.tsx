...
export default function RecruitPage() {
  return (
    <>
      ...
      <Suspense
        fallback={
          <main className="flex min-h-[calc(100svh-64px)] items-center justify-center px-5 text-center">
...
function RecruitContent() {
  ...
  return (
    <main className="flex min-h-[calc(100svh-64px)] flex-col px-5 pt-4 sm:px-8">
      <div className="mx-auto w-full max-w-3xl">
        <BackLink href="/#recruit" />
      </div>
